...
{
    public abstract class ECMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ECMSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ECMSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ECMSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ECMSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ECMSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ECMSDbContext, Task<T>> func)
        {
            T result;
